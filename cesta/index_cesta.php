...
<form action="insert_cesta.php" method="post">
  <div class="mb-3 container">
    ...
    <input type="text" class="form-control" name="ano_cesta" id="ano_cesta">
  </div>
  <div class="mb-3 container">
    <label for="valor_cesta" class="form-label">Valor</label>
    <input type="text" class="form-control" name="valor_cesta" id="valor_cesta">
  </div>
  <div class="container">
